 ...
 */
public abstract class GenericServiceImpl<Entity, Key> implements GenericService<Entity, Key> {

    private static final Logger logger = Logger.getLogger("GenericService");
    @PersistenceContext
